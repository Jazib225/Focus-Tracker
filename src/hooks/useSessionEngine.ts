...
const STUDY_TIPS = [
  'Take one slow breath and restate the next small task in your head.',
  'Move the distracting tab or device out of sight before you continue.',
  'Turn your goal into a single action, like reading one page or solving one problem.',
  'If the task feels heavy, work for two focused minutes before deciding what to do next.',
  'Keep only the materials for this study session open on screen.',
  'If you feel stuck, write one question you want to answer in the next few minutes.',
  'Sit back in frame and let the camera settle before you jump back in.',
  'A quick sip of water can help reset your attention without ending the session.',
  'When your mind drifts, start again with the easiest part of the task.',
  'Lowering noise around you for a minute can make the next stretch easier.',
  'Try reading the next line out loud once, then continue silently.',
  'If you are overwhelmed, split the work into one tiny checkpoint and finish that first.',
  'Put your phone face down or farther away until the next break.',
  'A short posture reset can help you settle back into focus.',
  'If the streak broke because of fatigue, shorten the next focus block instead of forcing it.',
  'Open notes, slides, and references side by side so you are not hunting for material.',
  'When attention slips, return to the exact sentence or problem you left off on.',
  'Try a cleaner desk angle if the camera is losing your eyes too often.',
];
